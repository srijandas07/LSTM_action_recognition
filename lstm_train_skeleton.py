...
parser.add_argument('-mode', '--mode', help='new/cross', default=30)
...
csvlogger = CSVLogger(name+'_ntu.csv')
mode = args.mode
...
train_generator = DataGenerator('/data/stars/user/sdas/NTU_RGB/splits/imp_files/train_'+mode+'.txt', batch_size = batch_size)
val_generator = DataGenerator('/data/stars/user/sdas/NTU_RGB/splits/imp_files/test_'+mode+'.txt', batch_size = batch_size)
#test_generator = DataGenerator('/data/stars/user/achaudha/NTU_RGB/splits_test_10/test_new.txt', batch_size = batch_size)
